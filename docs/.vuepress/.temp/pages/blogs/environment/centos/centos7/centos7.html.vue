...
</code></pre></div><h2 id="_2-2-解决远程连接无法连接的问题" tabindex="-1"><a class="header-anchor" href="#_2-2-解决远程连接无法连接的问题" aria-hidden="true">#</a> 2.2.解决远程连接无法连接的问题</h2>
<pre><code>修改sshd配置文件
...
</code></pre></div><h2 id="_2-3-设置系统环境变量" tabindex="-1"><a class="header-anchor" href="#_2-3-设置系统环境变量" aria-hidden="true">#</a> 2.3.设置系统环境变量</h2>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>echo "export LC_ALL=en_US.UTF-8"  >>  /etc/profile &amp;&amp;
source /etc/profile
</code></pre></div><h2 id="_2-4-安装curl" tabindex="-1"><a class="header-anchor" href="#_2-4-安装curl" aria-hidden="true">#</a> 2.4.安装curl</h2>
<pre><code>后面的操作需要curl，所以首先安装curl
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum -y install curl
</code></pre></div><h2 id="_2-5-配置yml源" tabindex="-1"><a class="header-anchor" href="#_2-5-配置yml源" aria-hidden="true">#</a> 2.5.配置yml源</h2>
...
</code></pre></div><h2 id="_2-6-安装常用基础系统软件" tabindex="-1"><a class="header-anchor" href="#_2-6-安装常用基础系统软件" aria-hidden="true">#</a> 2.6.安装常用基础系统软件</h2>
<h3 id="_2-6-1-手动安装常用基础软件" tabindex="-1"><a class="header-anchor" href="#_2-6-1-手动安装常用基础软件" aria-hidden="true">#</a> 2.6.1.手动安装常用基础软件</h3>
<pre><code>安装vim
</code></pre>
...
</code></pre></div><h3 id="_2-6-2-使用脚本安装常用软件" tabindex="-1"><a class="header-anchor" href="#_2-6-2-使用脚本安装常用软件" aria-hidden="true">#</a> 2.6.2.使用脚本安装常用软件</h3>
<pre><code>脚本介绍
...
./centos7-init.sh
</code></pre></div><h1 id="_3-搭建基础开发环境" tabindex="-1"><a class="header-anchor" href="#_3-搭建基础开发环境" aria-hidden="true">#</a> 3.搭建基础开发环境</h1>
...
</code></pre></div><h2 id="_3-2-安装maven" tabindex="-1"><a class="header-anchor" href="#_3-2-安装maven" aria-hidden="true">#</a> 3.2.安装maven</h2>
<pre><code>注意
...
&lt;mirror>
	...
	&lt;mirrorOf>central&lt;/mirrorOf>
&lt;/mirror>
</code></pre></div><h2 id="_3-3-安装mysql" tabindex="-1"><a class="header-anchor" href="#_3-3-安装mysql" aria-hidden="true">#</a> 3.3.安装mysql</h2>
<!--
	参考网站
	安装mysql
...
flush privileges;
</code></pre></div><h2 id="_3-4-安装nodejs" tabindex="-1"><a class="header-anchor" href="#_3-4-安装nodejs" aria-hidden="true">#</a> 3.4.安装nodejs</h2>
<pre><code>安装wget
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum -y install wget
...
</code></pre></div><h2 id="_3-5-安装fastgithub" tabindex="-1"><a class="header-anchor" href="#_3-5-安装fastgithub" aria-hidden="true">#</a> 3.5.安装fastgithub</h2>
<pre><code>下载依赖包
</code></pre>
...
</code></pre></div><h2 id="_3-6-安装git" tabindex="-1"><a class="header-anchor" href="#_3-6-安装git" aria-hidden="true">#</a> 3.6.安装git</h2>
<h3 id="_3-6-1-安装默认版本git" tabindex="-1"><a class="header-anchor" href="#_3-6-1-安装默认版本git" aria-hidden="true">#</a> 3.6.1.安装默认版本git</h3>
<pre><code>卸载旧版本
</code></pre>
...
</code></pre></div><h3 id="_3-6-2-安装指定版本git" tabindex="-1"><a class="header-anchor" href="#_3-6-2-安装指定版本git" aria-hidden="true">#</a> 3.6.2.安装指定版本git</h3>
<pre><code>下载需要安装的版本号
</code></pre>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>git version
</code></pre></div><h1 id="_4-搭建docker技术栈" tabindex="-1"><a class="header-anchor" href="#_4-搭建docker技术栈" aria-hidden="true">#</a> 4.搭建docker技术栈</h1>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum -y update
</code></pre></div><pre><code>查看当前安装的docker版本
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum list installed | grep docker
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum -y remove docker-ce.x86_64
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum install -y yum-utils device-mapper-persistent-data lvm2
</code></pre></div><pre><code>配置使用阿里的yum源
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum-config-manager --add-repo http://mirrors.aliyun.com/docker-ce/linux/centos/docker-ce.repo
</code></pre></div><pre><code>查看阿里云仓库中所有docker版本，并选择特定版本安装
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum list docker-ce --showduplicates | sort -r
</code></pre></div><pre><code>安装最新版本docker-ce(docker社区、ee企业版 ce为社区版)
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum -y install docker-ce
</code></pre></div><pre><code>查看安装的docker版本
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker version
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run hello-world
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>systemctl stop docker
</code></pre></div><pre><code>设置firewall不拦截docker
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>firewall-cmd --zone=trusted --remove-interface=docker0 --permanent
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>systemctl restart docker
</code></pre></div><pre><code>解决方式2：检查daemon.json配置是否正确
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>cat /etc/docker/daemon.json
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker search portainer
</code></pre></div><pre><code>下载portainer镜像
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker pull portainer/portainer:1.24.2
</code></pre></div><pre><code>启动单机版portainer(针对单机版docker)
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run -d --name portainer \
	-p 9000:9000 \
	--restart=always \
...
<h3 id="_4-4-1-搭建docke官方私服-不带有用户名和密码校验" tabindex="-1"><a class="header-anchor" href="#_4-4-1-搭建docke官方私服-不带有用户名和密码校验" aria-hidden="true">#</a> 4.4.1.搭建docke官方私服（不带有用户名和密码校验）</h3>
<pre><code>拉取仓库镜像
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker pull registry
</code></pre></div><pre><code>启动注册仓库服务器
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run -d --name registry_official \
	-p 5000:5000 \
	--restart=always \
...
</code></pre></div><h3 id="_4-4-2-搭建docke官方私服-带有用户名和密码校验" tabindex="-1"><a class="header-anchor" href="#_4-4-2-搭建docke官方私服-带有用户名和密码校验" aria-hidden="true">#</a> 4.4.2.搭建docke官方私服(带有用户名和密码校验)</h3>
<pre><code>拉取仓库镜像
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker pull registry
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>mkdir -p /opt/docker/auth/
</code></pre></div><pre><code>安装httpd工具
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum -y install httpd
</code></pre></div><pre><code>生成带有加密后用户信息的用户名密码
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>htpasswd -Bbn docker 123456  >/opt/docker/auth/htpasswd
</code></pre></div><pre><code>启动注册仓库服务器(-p:第一个5000是本地机器端口,第二个5000是docker容器中端口)
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run -d --name registry_official_auth  \
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>rm -rf /registry/public/repos/docker/registry/v2/repositories/springcloud-eureka/
</code></pre></div><h3 id="_4-4-3-搭建harbor私服" tabindex="-1"><a class="header-anchor" href="#_4-4-3-搭建harbor私服" aria-hidden="true">#</a> 4.4.3.搭建harbor私服</h3>
<h4 id="_4-4-3-1-harbor简介" tabindex="-1"><a class="header-anchor" href="#_4-4-3-1-harbor简介" aria-hidden="true">#</a> 4.4.3.1.harbor简介</h4>
...
<h4 id="_4-4-3-2-搭建docker-compose" tabindex="-1"><a class="header-anchor" href="#_4-4-3-2-搭建docker-compose" aria-hidden="true">#</a> 4.4.3.2.搭建docker-compose</h4>
<pre><code>版本说明
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker-compose --version
</code></pre></div><h4 id="_4-4-3-3-安装harbor" tabindex="-1"><a class="header-anchor" href="#_4-4-3-3-安装harbor" aria-hidden="true">#</a> 4.4.3.3.安装harbor</h4>
<pre><code>版本说明
本次使用的harbor版本为2.5.2
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>cd /opt/software/install/harbor &amp;&amp;
cp harbor.yml.tmpl harbor.yml
</code></pre></div><pre><code>修改harbor.yml配置
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>vim harbor.yml
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker-compose up -d
...
<h3 id="_4-5-1-docker-registry-web方案" tabindex="-1"><a class="header-anchor" href="#_4-5-1-docker-registry-web方案" aria-hidden="true">#</a> 4.5.1.docker-registry-web方案</h3>
<pre><code>下载docker pull hyper/docker-registry-web镜像
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker pull hyper/docker-registry-web
</code></pre></div><pre><code>启动docker-registry-web
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run -d --restart=always \
	-p 9002:8080 \
	--name registry-web \
...
</code></pre></div><h2 id="_4-6-制作docker镜像并上传到私服" tabindex="-1"><a class="header-anchor" href="#_4-6-制作docker镜像并上传到私服" aria-hidden="true">#</a> 4.6.制作docker镜像并上传到私服</h2>
<h3 id="_4-6-1-制作dokcer镜像" tabindex="-1"><a class="header-anchor" href="#_4-6-1-制作dokcer镜像" aria-hidden="true">#</a> 4.6.1.制作Dokcer镜像</h3>
<pre><code>下载地址
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>https://repo.huaweicloud.com/java/jdk/
</code></pre></div><pre><code>创建存放docker镜像的文件夹-&gt;在这个目录中下载jdk
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>mkdir -p /opt/software/docker/images &amp;&amp;
cd /opt/software/docker/images &amp;&amp;
wget https://repo.huaweicloud.com/java/jdk/8u181-b13/jdk-8u181-linux-x64.tar.gz
</code></pre></div><pre><code>编写Dockerfile(Dockerfile内容如下)
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>cat &lt;&lt;EOF > Dockerfile
#基于centos基础镜像构建
FROM centos
#作者
MAINTAINER lingwh
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker build -t='jdk/jdk1.8.0_181' .
</code></pre></div><pre><code>查看到刚才制作好的镜像
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker images
</code></pre></div><pre><code>创建容器
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run -it --name=myjdk8 镜像id /bin/bash
</code></pre></div><h3 id="_4-6-2-上传本地jdk镜像到私服" tabindex="-1"><a class="header-anchor" href="#_4-6-2-上传本地jdk镜像到私服" aria-hidden="true">#</a> 4.6.2.上传本地jdk镜像到私服</h3>
<pre><code>给镜像打标签
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker tag jdk/jdk1.8.0_181 192.168.0.4:5000/jdk/jdk1.8.0_181:latest
</code></pre></div><pre><code>上传标记的镜像
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker push 192.168.0.4:5000/jdk/jdk1.8.0_181:latest
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run -di --name mysql -p 3306:3306 --restart=always -e MYSQL_ROOT_PASSWORD=123456 mysql
...
</code></pre></div><h3 id="_4-7-2-docker中安装consul" tabindex="-1"><a class="header-anchor" href="#_4-7-2-docker中安装consul" aria-hidden="true">#</a> 4.7.2.Docker中安装consul</h3>
<pre><code>下载consul镜像
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker pull consul
</code></pre></div><pre><code>启动consul容器
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run -d --name=consul \
	-p 8500:8500 \
	--restart=always \
	agent -server -bootstrap -ui -node=1 -client='0.0.0.0' \
	consul:latest
</code></pre></div><h3 id="_4-7-3-docker容器中安装vim" tabindex="-1"><a class="header-anchor" href="#_4-7-3-docker容器中安装vim" aria-hidden="true">#</a> 4.7.3.Docker容器中安装vim</h3>
<pre><code>进入容器内部
</code></pre>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>mv /etc/apt/sources.list /etc/apt/sources.list.bak
</code></pre></div><pre><code>写入新的源
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>echo "deb http://mirrors.163.com/debian/ jessie main non-free contrib" \
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>apt update
</code></pre></div><pre><code>安装vim
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>apt-get install vim
</code></pre></div><h3 id="_4-7-3-docker安装elk" tabindex="-1"><a class="header-anchor" href="#_4-7-3-docker安装elk" aria-hidden="true">#</a> 4.7.3.docker安装elk</h3>
<pre><code>下载elk镜像
</code></pre>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run -d --name elk \
	--restart always \
	-p 5601:5601 \
	-p 9200:9200 \
	-p 5044:5044 \
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>firewall-cmd --add-port=5601/tcp --permanent &amp;&amp;
firewall-cmd --reload &amp;&amp;
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>exit
</code></pre></div><pre><code>重启ELK容器
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker restart elk
</code></pre></div><pre><code>注意事项
当把docker和centos7的冲突解决后,需要让centos放行elk(具体是es)的部署地址

查看容器详细信息
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker inspect 容器id
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>sudo sysctl -w vm.max_map_count=262144
</code></pre></div><h1 id="_5-搭建rancher技术栈" tabindex="-1"><a class="header-anchor" href="#_5-搭建rancher技术栈" aria-hidden="true">#</a> 5.搭建Rancher技术栈</h1>
<pre><code>下载rancher
</code></pre>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>docker run -di --name=rancher -p9003:8080 rancher/server:latest
...
<h1 id="_6-搭建minikube" tabindex="-1"><a class="header-anchor" href="#_6-搭建minikube" aria-hidden="true">#</a> 6.搭建Minikube</h1>
...
<pre><code>minikube:1.2.6 kubectl:1.18.0
</code></pre>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>grep -E --color 'vmx|svm' /proc/cpuinfo
...
</code></pre></div><h2 id="_6-5-安装minikube" tabindex="-1"><a class="header-anchor" href="#_6-5-安装minikube" aria-hidden="true">#</a> 6.5.安装minikube</h2>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>minikube version
</code></pre></div><h2 id="_6-6-使用阿里云加速docker-hub" tabindex="-1"><a class="header-anchor" href="#_6-6-使用阿里云加速docker-hub" aria-hidden="true">#</a> 6.6.使用阿里云加速docker hub</h2>
<pre><code>登录阿里云docker相关页面
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>https://cr.console.aliyun.com/cn-hangzhou/instances/mirrors
</code></pre></div><pre><code>登陆-&gt;左侧菜单选中镜像加速器-&gt;查看加速镜像地址
我的加速地址是：https://ngviu28h.mirror.aliyuncs.com
</code></pre>
<h2 id="_6-7-启动minikube-下面两种启动方式任选一种" tabindex="-1"><a class="header-anchor" href="#_6-7-启动minikube-下面两种启动方式任选一种" aria-hidden="true">#</a> 6.7.启动minikube(下面两种启动方式任选一种)</h2>
<h3 id="_6-7-1-使用docker作为虚拟化引擎-需要先安装docker" tabindex="-1"><a class="header-anchor" href="#_6-7-1-使用docker作为虚拟化引擎-需要先安装docker" aria-hidden="true">#</a> 6.7.1.使用docker作为虚拟化引擎(需要先安装Docker)</h3>
<pre><code>注意事项
启动minikube之前需要先启动docker，如无法启动加上--kubernetes-version=v具体版本号

启动minikube
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>minikube start --driver=docker --force \
	--image-mirror-country='cn' \
	--image-repository='registry.cn-hangzhou.aliyuncs.com/google_containers' \
	--registry-mirror='https://ngviu28h.mirror.aliyuncs.com' \
	--kubernetes-version=v1.23.8
</code></pre></div><h3 id="_6-7-2-使用virtualbox作为虚拟化引擎-需要先安装virtualbox" tabindex="-1"><a class="header-anchor" href="#_6-7-2-使用virtualbox作为虚拟化引擎-需要先安装virtualbox" aria-hidden="true">#</a> 6.7.2.使用virtualbox作为虚拟化引擎(需要先安装Virtualbox)</h3>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>sudo yum install gcc kernel kernel-devel -y
</code></pre></div><pre><code>重启机器
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>systemctl reboot
</code></pre></div><pre><code>安装VirtualBox
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum install VirtualBox-6.1-6.1.34_150636_el7-2.x86_64.rpm -y
</code></pre></div><pre><code>补充内容：Centos版VirtualBox操作命令
VBoxManage list runningvms //查看机器列表
VBoxHeadless -startvm &quot;虚拟机名&quot; //启动虚拟机
测试VirtualBox是否安装成功
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>virtualbox
</code></pre></div><pre><code>使用virtualbox作为虚拟化引擎
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>minikube start --driver=virtualbox --force \
	--image-mirror-country='cn' \
	--image-repository='registry.cn-hangzhou.aliyuncs.com/google_containers' \
	--registry-mirror='https://ngviu28h.mirror.aliyuncs.com' \
	--kubernetes-version=v1.23.8
</code></pre></div><h2 id="_6-8-安装dashboard" tabindex="-1"><a class="header-anchor" href="#_6-8-安装dashboard" aria-hidden="true">#</a> 6.8.安装dashboard</h2>
<pre><code>安装dashboard
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>minikube dashboard
</code></pre></div><pre><code>设置其他机器也可以访问dashboard
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>kubectl proxy --port=8001 --address='192.168.0.4' --accept-hosts='^.*' &amp;
</code></pre></div><pre><code>开放访问端口
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>firewall-cmd --zone=public --add-port=8001/tcp --permanent &amp;&amp;
firewall-cmd --reload
</code></pre></div><pre><code>访问kubectl dashboard
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>http://192.168.0.4:8001/api/v1/namespaces/kubernetes-dashboard/services/http:kubernetes-dashboard:/proxy/
</code></pre></div><h2 id="_6-10-部署测试程序" tabindex="-1"><a class="header-anchor" href="#_6-10-部署测试程序" aria-hidden="true">#</a> 6.10.部署测试程序</h2>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>kubectl port-forward --address 0.0.0.0 pod/guestbook-5bccb95cd6-dk6zh 7080:3000
</code></pre></div><pre><code>开放访问端口
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>firewall-cmd --zone=public --add-port=7080/tcp --permanent &amp;&amp;
firewall-cmd --reload
</code></pre></div><pre><code>访问服务（主节点和两个工作节点都可访问到这个服务）
http://192.168.0.4:7080
</code></pre>
<h2 id="_6-10-minikube常用命令" tabindex="-1"><a class="header-anchor" href="#_6-10-minikube常用命令" aria-hidden="true">#</a> 6.10.minikube常用命令</h2>
<pre><code>查看minikube日志
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>minikube logs
</code></pre></div><pre><code>查看minikube状态
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>minikube status
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>minikube kubectl -- get po -A
</code></pre></div><pre><code>查看所有命名空间的pod
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>kubectl get pods --all-namespaces
...
</code></pre></div><h1 id="_7-kubeadm搭建kubernetes" tabindex="-1"><a class="header-anchor" href="#_7-kubeadm搭建kubernetes" aria-hidden="true">#</a> 7.kubeadm搭建Kubernetes</h1>
...
</code></pre></div><h2 id="_7-5-所有节点关闭防火墙" tabindex="-1"><a class="header-anchor" href="#_7-5-所有节点关闭防火墙" aria-hidden="true">#</a> 7.5.所有节点关闭防火墙</h2>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>systemctl stop firewalld &amp;&amp;
systemctl disable firewalld
</code></pre></div><h2 id="_7-6-所有节点安装docker" tabindex="-1"><a class="header-anchor" href="#_7-6-所有节点安装docker" aria-hidden="true">#</a> 7.6.所有节点安装docker</h2>
<pre><code>安装docker
详细参考4.1&gt;.安装docker
...
</code></pre></div><h2 id="_7-8-所有节点启动kubelet和docker" tabindex="-1"><a class="header-anchor" href="#_7-8-所有节点启动kubelet和docker" aria-hidden="true">#</a> 7.8.所有节点启动kubelet和docker</h2>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>systemctl enable kubelet &amp;&amp;
systemctl start kubelet &amp;&amp;
systemctl enable docker &amp;&amp;
systemctl start docker
</code></pre></div><h2 id="_7-9-所有关闭swap" tabindex="-1"><a class="header-anchor" href="#_7-9-所有关闭swap" aria-hidden="true">#</a> 7.9.所有关闭swap</h2>
<pre><code>临时关闭swap分区
</code></pre>
...
</code></pre></div><h2 id="_7-10-用kubeadm-初始化集群" tabindex="-1"><a class="header-anchor" href="#_7-10-用kubeadm-初始化集群" aria-hidden="true">#</a> 7.10.用kubeadm 初始化集群</h2>
<pre><code>特别注意
只在Master节点操作
...
</code></pre></div><h2 id="_7-14-在master上查看集群节点" tabindex="-1"><a class="header-anchor" href="#_7-14-在master上查看集群节点" aria-hidden="true">#</a> 7.14.在master上查看集群节点</h2>
...
</code></pre></div><h2 id="_7-17-部署测试程序" tabindex="-1"><a class="header-anchor" href="#_7-17-部署测试程序" aria-hidden="true">#</a> 7.17.部署测试程序</h2>
<pre><code>开始运行 guestbook
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>kubectl create deployment guestbook --image=ibmcom/guestbook:v1
</code></pre></div><pre><code>查询pod运行状态，状态应该显示为Running表示pod运行成功
...
</code></pre></div><h1 id="_8-二进制包搭建kubernetes" tabindex="-1"><a class="header-anchor" href="#_8-二进制包搭建kubernetes" aria-hidden="true">#</a> 8.二进制包搭建Kubernetes</h1>
<!--
	参考网站
...
</code></pre></div><h2 id="_8-4-安装cfssl证书生成工具" tabindex="-1"><a class="header-anchor" href="#_8-4-安装cfssl证书生成工具" aria-hidden="true">#</a> 8.4.安装cfssl证书生成工具</h2>
<div class="custom-container tip"><p class="custom-container-title">注意事项</p>
...
</code></pre></div><h2 id="_8-5-搭建etcd集群" tabindex="-1"><a class="header-anchor" href="#_8-5-搭建etcd集群" aria-hidden="true">#</a> 8.5.搭建etcd集群</h2>
<div class="custom-container tip"><p class="custom-container-title">注意事项</p>
...
</code></pre></div><h3 id="_8-5-2-部署etcd集群" tabindex="-1"><a class="header-anchor" href="#_8-5-2-部署etcd集群" aria-hidden="true">#</a> 8.5.2.部署etcd集群</h3>
<pre><code>etcd简介
...
</code></pre></div><h3 id="_8-5-5-让systemd管理etcd" tabindex="-1"><a class="header-anchor" href="#_8-5-5-让systemd管理etcd" aria-hidden="true">#</a> 8.5.5.让systemd管理etcd</h3>
...
WantedBy=multi-user.target
EOF
</code></pre></div><h3 id="_8-5-6-拷贝etcd安装文件到worker-node" tabindex="-1"><a class="header-anchor" href="#_8-5-6-拷贝etcd安装文件到worker-node" aria-hidden="true">#</a> 8.5.6.拷贝etcd安装文件到Worker Node</h3>
<div class="custom-container tip"><p class="custom-container-title">注意事项</p>
...
</code></pre></div><h2 id="_8-6-安装配置docker" tabindex="-1"><a class="header-anchor" href="#_8-6-安装配置docker" aria-hidden="true">#</a> 8.6.安装配置Docker</h2>
<div class="custom-container tip"><p class="custom-container-title">注意事项</p>
...
WantedBy=multi-user.target
EOF
</code></pre></div><h3 id="_8-6-2在所有worker-node上安装docker" tabindex="-1"><a class="header-anchor" href="#_8-6-2在所有worker-node上安装docker" aria-hidden="true">#</a> 8.6.2在所有Worker Node上安装docker</h3>
<div class="custom-container tip"><p class="custom-container-title">注意事项</p>
...
</code></pre></div><h3 id="_8-6-3启动三台机器上的docker" tabindex="-1"><a class="header-anchor" href="#_8-6-3启动三台机器上的docker" aria-hidden="true">#</a> 8.6.3启动三台机器上的docker</h3>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>systemctl status docker
</code></pre></div><h2 id="_8-7-搭建kube-apiserver" tabindex="-1"><a class="header-anchor" href="#_8-7-搭建kube-apiserver" aria-hidden="true">#</a> 8.7.搭建kube-apiserver</h2>
<div class="custom-container tip"><p class="custom-container-title">注意事项</p>
...
</code></pre></div><h3 id="_8-7-2-在master-node1上部署kube-apiserver" tabindex="-1"><a class="header-anchor" href="#_8-7-2-在master-node1上部署kube-apiserver" aria-hidden="true">#</a> 8.7.2.在Master Node1上部署kube-apiserver</h3>
...
</code></pre></div><h3 id="_8-7-4-启用tls-bootstrapping" tabindex="-1"><a class="header-anchor" href="#_8-7-4-启用tls-bootstrapping" aria-hidden="true">#</a> 8.7.4.启用TLS bootstrapping</h3>
...
WantedBy=multi-user.target
EOF
</code></pre></div><h3 id="_8-7-6-启动kube-apiserver" tabindex="-1"><a class="header-anchor" href="#_8-7-6-启动kube-apiserver" aria-hidden="true">#</a> 8.7.6.启动kube-apiserver</h3>
...
</code></pre></div><h2 id="_8-8-在master-node1上部署kube-controller-manager" tabindex="-1"><a class="header-anchor" href="#_8-8-在master-node1上部署kube-controller-manager" aria-hidden="true">#</a> 8.8.在Master Node1上部署kube-controller-manager</h2>
<div class="custom-container tip"><p class="custom-container-title">注意事项</p>
...
</code></pre></div><h3 id="_8-8-2-生成证书" tabindex="-1"><a class="header-anchor" href="#_8-8-2-生成证书" aria-hidden="true">#</a> 8.8.2.生成证书</h3>
<pre><code>切换工作目录
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>cd ~/TLS/k8s
...
</code></pre></div><h3 id="_8-8-2-创建kube-controller-manager配置文件" tabindex="-1"><a class="header-anchor" href="#_8-8-2-创建kube-controller-manager配置文件" aria-hidden="true">#</a> 8.8.2.创建kube-controller-manager配置文件</h3>
...
</code></pre></div><h3 id="_8-8-4-让systemd管理controller-manager" tabindex="-1"><a class="header-anchor" href="#_8-8-4-让systemd管理controller-manager" aria-hidden="true">#</a> 8.8.4.让systemd管理controller-manager</h3>
...
WantedBy=multi-user.target
EOF
</code></pre></div><h3 id="_8-8-5-启动kube-controller-manager" tabindex="-1"><a class="header-anchor" href="#_8-8-5-启动kube-controller-manager" aria-hidden="true">#</a> 8.8.5.启动kube-controller-manager</h3>
...
</code></pre></div><h2 id="_8-9-部署kube-scheduler" tabindex="-1"><a class="header-anchor" href="#_8-9-部署kube-scheduler" aria-hidden="true">#</a> 8.9.部署kube-scheduler</h2>
<div class="custom-container tip"><p class="custom-container-title">注意事项</p>
...
</code></pre></div><h3 id="_8-9-2-生成证书" tabindex="-1"><a class="header-anchor" href="#_8-9-2-生成证书" aria-hidden="true">#</a> 8.9.2.生成证书</h3>
<pre><code>切换工作目录
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>cd ~/TLS/k8s
...
</code></pre></div><h3 id="_8-9-3-创建kube-scheduler-conf配置文件" tabindex="-1"><a class="header-anchor" href="#_8-9-3-创建kube-scheduler-conf配置文件" aria-hidden="true">#</a> 8.9.3.创建kube-scheduler.conf配置文件</h3>
...
kubectl config use-context default --kubeconfig=${KUBE_CONFIG}
</code></pre></div><h3 id="_8-9-5-让systemd管理kube-scheduler" tabindex="-1"><a class="header-anchor" href="#_8-9-5-让systemd管理kube-scheduler" aria-hidden="true">#</a> 8.9.5.让systemd管理kube-scheduler</h3>
...
WantedBy=multi-user.target
EOF
</code></pre></div><h3 id="_8-9-6-启动并设置开机启动" tabindex="-1"><a class="header-anchor" href="#_8-9-6-启动并设置开机启动" aria-hidden="true">#</a> 8.9.6.启动并设置开机启动</h3>
...
</code></pre></div><h2 id="_8-10-使用kubectl查看集群状态" tabindex="-1"><a class="header-anchor" href="#_8-10-使用kubectl查看集群状态" aria-hidden="true">#</a> 8.10.使用kubectl查看集群状态</h2>
<div class="custom-container tip"><p class="custom-container-title">注意事项</p>
...
</code></pre></div><h3 id="_8-10-2-在-kube文件夹中生成config文件" tabindex="-1"><a class="header-anchor" href="#_8-10-2-在-kube文件夹中生成config文件" aria-hidden="true">#</a> 8.10.2.在.kube文件夹中生成config文件</h3>
...
kubectl config use-context default --kubeconfig=${KUBE_CONFIG}
</code></pre></div><h3 id="_8-10-3-通过kubectl工具查看集群组件" tabindex="-1"><a class="header-anchor" href="#_8-10-3-通过kubectl工具查看集群组件" aria-hidden="true">#</a> 8.10.3.通过kubectl工具查看集群组件</h3>
<pre><code>命令
</code></pre>
...
</code></pre></div><h3 id="_8-11-2-在master-node1部署kubelet" tabindex="-1"><a class="header-anchor" href="#_8-11-2-在master-node1部署kubelet" aria-hidden="true">#</a> 8.11.2.在Master Node1部署kubelet</h3>
...
maxPods: 110
EOF
</code></pre></div><h4 id="_8-11-2-3-生成kubelet初次加入集群引导kubeconfig文件" tabindex="-1"><a class="header-anchor" href="#_8-11-2-3-生成kubelet初次加入集群引导kubeconfig文件" aria-hidden="true">#</a> 8.11.2.3.生成kubelet初次加入集群引导kubeconfig文件</h4>
...
kubectl config use-context default --kubeconfig=${KUBE_CONFIG}
</code></pre></div><h4 id="_8-11-2-4-systemd管理kubelet" tabindex="-1"><a class="header-anchor" href="#_8-11-2-4-systemd管理kubelet" aria-hidden="true">#</a> 8.11.2.4.systemd管理kubelet</h4>
...
WantedBy=multi-user.target
EOF
</code></pre></div><h4 id="_8-11-3-5-启动kubelet并设置开机启动" tabindex="-1"><a class="header-anchor" href="#_8-11-3-5-启动kubelet并设置开机启动" aria-hidden="true">#</a> 8.11.3.5.启动kubelet并设置开机启动</h4>
...
</code></pre></div><h4 id="_8-11-2-6-允许kubelet证书申请并加入集群" tabindex="-1"><a class="header-anchor" href="#_8-11-2-6-允许kubelet证书申请并加入集群" aria-hidden="true">#</a> 8.11.2.6.允许kubelet证书申请并加入集群</h4>
...
EOF
</code></pre></div><h4 id="_8-11-3-2-配置参数文件" tabindex="-1"><a class="header-anchor" href="#_8-11-3-2-配置参数文件" aria-hidden="true">#</a> 8.11.3.2.配置参数文件</h4>
...
EOF
</code></pre></div><h4 id="_8-11-3-3-生成kube-proxy证书文件" tabindex="-1"><a class="header-anchor" href="#_8-11-3-3-生成kube-proxy证书文件" aria-hidden="true">#</a> 8.11.3.3.生成kube-proxy证书文件</h4>
<pre><code>切换工作目录
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>cd ~/TLS/k8s
</code></pre></div><pre><code>创建证书请求文件
...
</code></pre></div><h4 id="_8-11-3-4-生成kube-proxy-kubeconfig文件" tabindex="-1"><a class="header-anchor" href="#_8-11-3-4-生成kube-proxy-kubeconfig文件" aria-hidden="true">#</a> 8.11.3.4.生成kube-proxy.kubeconfig文件</h4>
...
kubectl config use-context default --kubeconfig=${KUBE_CONFIG}
</code></pre></div><h4 id="_8-11-3-5-systemd管理kube-proxy" tabindex="-1"><a class="header-anchor" href="#_8-11-3-5-systemd管理kube-proxy" aria-hidden="true">#</a> 8.11.3.5.systemd管理kube-proxy</h4>
...
WantedBy=multi-user.target
EOF
</code></pre></div><h4 id="_8-10-3-6-启动kube-proxy并设置开机自启" tabindex="-1"><a class="header-anchor" href="#_8-10-3-6-启动kube-proxy并设置开机自启" aria-hidden="true">#</a> 8.10.3.6.启动kube-proxy并设置开机自启</h4>
...
</code></pre></div><h3 id="_8-11-4-部署网络组件-calico" tabindex="-1"><a class="header-anchor" href="#_8-11-4-部署网络组件-calico" aria-hidden="true">#</a> 8.11.4.部署网络组件(Calico)</h3>
<pre><code>Calico简介
...
</code></pre></div><h2 id="_8-12-增加worker-node" tabindex="-1"><a class="header-anchor" href="#_8-12-增加worker-node" aria-hidden="true">#</a> 8.12.增加Worker Node</h2>
...
</code></pre></div><h3 id="_8-12-2拷贝master-node1上部署好的文件到worker-node" tabindex="-1"><a class="header-anchor" href="#_8-12-2拷贝master-node1上部署好的文件到worker-node" aria-hidden="true">#</a> 8.12.2拷贝Master Node1上部署好的文件到Worker Node</h3>
...
</code></pre></div><h3 id="_8-12-3-删除所有worker-node中kubelet证书和kubeconfig文件" tabindex="-1"><a class="header-anchor" href="#_8-12-3-删除所有worker-node中kubelet证书和kubeconfig文件" aria-hidden="true">#</a> 8.12.3.删除所有Worker Node中kubelet证书和kubeconfig文件</h3>
...
</code></pre></div><h3 id="_8-12-5-启动worker-node1和worker-node2中kubelet并设置开机自启" tabindex="-1"><a class="header-anchor" href="#_8-12-5-启动worker-node1和worker-node2中kubelet并设置开机自启" aria-hidden="true">#</a> 8.12.5.启动Worker Node1和Worker Node2中kubelet并设置开机自启</h3>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>systemctl daemon-reload &amp;&amp;
...
</code></pre></div><h3 id="_8-12-6-在master1上同意新的node-kubelet证书申请" tabindex="-1"><a class="header-anchor" href="#_8-12-6-在master1上同意新的node-kubelet证书申请" aria-hidden="true">#</a> 8.12.6.在Master1上同意新的Node kubelet证书申请</h3>
<pre><code>查看证书请求
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>kubectl get csr
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>	systemctl status docker
</code></pre></div><h3 id="_8-13-5-给master-node2节点拷贝所有需要的证书" tabindex="-1"><a class="header-anchor" href="#_8-13-5-给master-node2节点拷贝所有需要的证书" aria-hidden="true">#</a> 8.13.5.给Master Node2节点拷贝所有需要的证书</h3>
...
systemctl enable kubelet &amp;&amp;
systemctl enable kube-proxy
</code></pre></div><h3 id="_8-13-7-在master查看集群组件状态" tabindex="-1"><a class="header-anchor" href="#_8-13-7-在master查看集群组件状态" aria-hidden="true">#</a> 8.13.7.在Master查看集群组件状态</h3>
...
WantedBy=multi-user.target
EOF
</code></pre></div><h3 id="_8-14-4-启动nginx、keepalived并设置开机自启-master1-master2" tabindex="-1"><a class="header-anchor" href="#_8-14-4-启动nginx、keepalived并设置开机自启-master1-master2" aria-hidden="true">#</a> 8.14.4.启动nginx、keepalived并设置开机自启(master1/master2)</h3>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>systemctl daemon-reload &amp;&amp;
systemctl start nginx keepalived &amp;&amp;
systemctl enable nginx keepalived
</code></pre></div><h3 id="_8-14-5-查看keepalived工作状态" tabindex="-1"><a class="header-anchor" href="#_8-14-5-查看keepalived工作状态" aria-hidden="true">#</a> 8.14.5.查看keepalived工作状态</h3>
...
<h1 id="_9-搭建持续集成环境" tabindex="-1"><a class="header-anchor" href="#_9-搭建持续集成环境" aria-hidden="true">#</a> 9.搭建持续集成环境</h1>
<h2 id="_9-1-使用本地内网穿透搭建持续集成环境" tabindex="-1"><a class="header-anchor" href="#_9-1-使用本地内网穿透搭建持续集成环境" aria-hidden="true">#</a> 9.1.使用本地内网穿透搭建持续集成环境</h2>
<h3 id="_9-1-1-持续集成环境组件列表" tabindex="-1"><a class="header-anchor" href="#_9-1-1-持续集成环境组件列表" aria-hidden="true">#</a> 9.1.1.持续集成环境组件列表</h3>
<pre><code>Jenkins、git、maven、docker
</code></pre>
<h3 id="_9-1-2-安装jekins" tabindex="-1"><a class="header-anchor" href="#_9-1-2-安装jekins" aria-hidden="true">#</a> 9.1.2.安装jekins</h3>
<pre><code>下载tomcat
...
<h3 id="_9-1-3-安装jdk" tabindex="-1"><a class="header-anchor" href="#_9-1-3-安装jdk" aria-hidden="true">#</a> 9.1.3.安装jdk</h3>
<pre><code>详细参考 3.搭建基础开发环境-&gt;3.1.安装jdk
</code></pre>
<h3 id="_9-1-4-安装maven" tabindex="-1"><a class="header-anchor" href="#_9-1-4-安装maven" aria-hidden="true">#</a> 9.1.4.安装maven</h3>
...
<h3 id="_9-1-5-安装git" tabindex="-1"><a class="header-anchor" href="#_9-1-5-安装git" aria-hidden="true">#</a> 9.1.5.安装git</h3>
<pre><code>详细参考 3.搭建基础开发环境-&gt;3.6.安装git-&gt;3.6.1.安装默认版本git
</code></pre>
<h3 id="_9-1-6-启动jenkins" tabindex="-1"><a class="header-anchor" href="#_9-1-6-启动jenkins" aria-hidden="true">#</a> 9.1.6.启动Jenkins</h3>
...
<h3 id="_9-1-7-安装配置jenkins用到的插件" tabindex="-1"><a class="header-anchor" href="#_9-1-7-安装配置jenkins用到的插件" aria-hidden="true">#</a> 9.1.7.安装配置Jenkins用到的插件</h3>
...
<h3 id="_9-1-8-搭建内网穿透" tabindex="-1"><a class="header-anchor" href="#_9-1-8-搭建内网穿透" aria-hidden="true">#</a> 9.1.8.搭建内网穿透</h3>
<pre><code>下载natapp
...
<h2 id="_9-2-使用coding内网穿透搭建持续集成环境" tabindex="-1"><a class="header-anchor" href="#_9-2-使用coding内网穿透搭建持续集成环境" aria-hidden="true">#</a> 9.2.使用Coding内网穿透搭建持续集成环境</h2>
<h3 id="_9-2-1-持续集成环境组件列表" tabindex="-1"><a class="header-anchor" href="#_9-2-1-持续集成环境组件列表" aria-hidden="true">#</a> 9.2.1.持续集成环境组件列表</h3>
<pre><code>git、maven、Coding.net
</code></pre>
<h3 id="_9-2-2-安装jdk" tabindex="-1"><a class="header-anchor" href="#_9-2-2-安装jdk" aria-hidden="true">#</a> 9.2.2.安装jdk</h3>
<pre><code>详细参考 3.搭建基础开发环境-&gt;3.1.安装jdk
</code></pre>
<h3 id="_9-2-3-安装maven" tabindex="-1"><a class="header-anchor" href="#_9-2-3-安装maven" aria-hidden="true">#</a> 9.2.3.安装maven</h3>
<pre><code>详细参考 3.搭建基础开发环境-&gt;3.2.安装maven
...
<h3 id="_9-2-4-安装git" tabindex="-1"><a class="header-anchor" href="#_9-2-4-安装git" aria-hidden="true">#</a> 9.2.4.安装git</h3>
<pre><code>详细参考 3.搭建基础开发环境-&gt;3.6.安装git-&gt;3.6.2.安装指定版本git(Coding需要高版本的git)
</code></pre>
<h3 id="_9-2-5-使用coding提供的接入命令搭建持续集成环境" tabindex="-1"><a class="header-anchor" href="#_9-2-5-使用coding提供的接入命令搭建持续集成环境" aria-hidden="true">#</a> 9.2.5.使用Coding提供的接入命令搭建持续集成环境</h3>
<pre><code>登录Coding(这里换成自己的Coding.net用户名)
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>https://lingwh.coding.net/p/java/ci/agent
...
</code></pre></div><h3 id="_9-2-6-安装配置jenkins用到的插件" tabindex="-1"><a class="header-anchor" href="#_9-2-6-安装配置jenkins用到的插件" aria-hidden="true">#</a> 9.2.6.安装配置Jenkins用到的插件</h3>
<pre><code>Publish Over SSH
...
<h1 id="_10-搭建mycat技术栈" tabindex="-1"><a class="header-anchor" href="#_10-搭建mycat技术栈" aria-hidden="true">#</a> 10.搭建Mycat技术栈</h1>
<h2 id="_10-1-安装myact1-6" tabindex="-1"><a class="header-anchor" href="#_10-1-安装myact1-6" aria-hidden="true">#</a> 10.1.安装myact1.6</h2>
<h3 id="_10-1-1-服务器环境说明" tabindex="-1"><a class="header-anchor" href="#_10-1-1-服务器环境说明" aria-hidden="true">#</a> 10.1.1.服务器环境说明</h3>
<pre><code>192.168.0.6 mycat1.6
192.168.0.7 mysql
192.168.0.8 mysql
</code></pre>
<h3 id="_10-1-2-搭建jdk" tabindex="-1"><a class="header-anchor" href="#_10-1-2-搭建jdk" aria-hidden="true">#</a> 10.1.2.搭建JDK</h3>
<pre><code>详细参考 3.搭建基础开发环境-&gt;3.1.安装jdk
</code></pre>
<h3 id="_10-1-3-搭建myact1-6" tabindex="-1"><a class="header-anchor" href="#_10-1-3-搭建myact1-6" aria-hidden="true">#</a> 10.1.3.搭建myact1.6</h3>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>chomd 777 mysql-connector-java-8.0.29.jar &amp;&amp;
cp mysql-connector-java-8.0.29.jar /usr/local/bin/mycat/lib/	
</code></pre></div><h3 id="_10-1-4-在各个节点上安装mysql" tabindex="-1"><a class="header-anchor" href="#_10-1-4-在各个节点上安装mysql" aria-hidden="true">#</a> 10.1.4.在各个节点上安装mysql</h3>
...
<h3 id="_10-1-5-配置mycat" tabindex="-1"><a class="header-anchor" href="#_10-1-5-配置mycat" aria-hidden="true">#</a> 10.1.5.配置mycat</h3>
<pre><code>notepad++安装插件
notepad++安装nppftp这个插件，连接到远程服务器之后自动可以编辑远程服务器的文本文件
</code></pre>
<h3 id="_10-1-6-启动和关闭mycat-默认端口8066" tabindex="-1"><a class="header-anchor" href="#_10-1-6-启动和关闭mycat-默认端口8066" aria-hidden="true">#</a> 10.1.6.启动和关闭mycat，默认端口8066</h3>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>/bin/mycat stop
</code></pre></div><pre><code>查看mycat日志
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>tail -f logs/wrapper.log 
</code></pre></div><pre><code>查看mycat状态
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>bin/mycat status
</code></pre></div><pre><code>前台启动mycat	
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>bin/mycat console #前台启动
</code></pre></div><h2 id="_10-2-搭建mycat2" tabindex="-1"><a class="header-anchor" href="#_10-2-搭建mycat2" aria-hidden="true">#</a> 10.2.搭建mycat2</h2>
<h3 id="_10-2-1-服务器环境说明" tabindex="-1"><a class="header-anchor" href="#_10-2-1-服务器环境说明" aria-hidden="true">#</a> 10.2.1.服务器环境说明</h3>
<pre><code>注意事项
...
<h3 id="_10-2-2-搭建jdk" tabindex="-1"><a class="header-anchor" href="#_10-2-2-搭建jdk" aria-hidden="true">#</a> 10.2.2.搭建JDK</h3>
<pre><code>详细参考 3.搭建基础开发环境-&gt;3.1.安装jdk
</code></pre>
<h3 id="_10-2-3-安装mycat2自身运行需要的mysql8-192-168-0-6" tabindex="-1"><a class="header-anchor" href="#_10-2-3-安装mycat2自身运行需要的mysql8-192-168-0-6" aria-hidden="true">#</a> 10.2.3.安装mycat2自身运行需要的mysql8(192.168.0.6)</h3>
<pre><code>创建用户mycat（注意：不能使用root用户，必须创建mycat这个用户）
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>CREATE USER 'mycat'@'%' IDENTIFIED BY 'Mysql123456_';
</code></pre></div><pre><code>赋予权限
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>GRANT XA_RECOVER_ADMIN ON *.* TO 'root'@'%';
</code></pre></div><pre><code>赋予权限
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>GRANT ALL PRIVILEGES ON *.* TO 'mycat'@'%' ;
</code></pre></div><pre><code>刷新配置
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>flush privileges;
</code></pre></div><h3 id="_10-2-3-组装mycat2完整程序包" tabindex="-1"><a class="header-anchor" href="#_10-2-3-组装mycat2完整程序包" aria-hidden="true">#</a> 10.2.3.组装mycat2完整程序包</h3>
<pre><code>下载mycat2外壳
</code></pre>
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>cd /opt/software/package/mycat2-install-template-1.20/mycat/conf/datasource
</code></pre></div><div class="language-text ext-text"><pre v-pre class="language-text"><code>vim prototypeDs.datasource.json
...
<h3 id="_10-2-4-在各个节点上安装mysql" tabindex="-1"><a class="header-anchor" href="#_10-2-4-在各个节点上安装mysql" aria-hidden="true">#</a> 10.2.4.在各个节点上安装mysql</h3>
<pre><code>在节点1安装mysql8.0.29(192.168.0.7)
详细参考 3.搭建基础开发环境-&gt;3.3.安装mysql
...
<h3 id="_10-2-5-配置mycat" tabindex="-1"><a class="header-anchor" href="#_10-2-5-配置mycat" aria-hidden="true">#</a> 10.2.5.配置mycat</h3>
<pre><code>notepad++安装插件
notepad++安装nppftp这个插件，连接到远程服务器之后自动可以编辑远程服务器的文本文件
</code></pre>
<h3 id="_10-2-6-启动和关闭mycat-默认端口8066" tabindex="-1"><a class="header-anchor" href="#_10-2-6-启动和关闭mycat-默认端口8066" aria-hidden="true">#</a> 10.2.6.启动和关闭mycat，默认端口8066</h3>
<pre><code>进入mycat安装目录
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>cd /usr/local/bin/mycat
</code></pre></div><pre><code>启动mycat
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>bin/mycat console #前台启动
</code></pre></div><h1 id="_11-搭建常用私服环境" tabindex="-1"><a class="header-anchor" href="#_11-搭建常用私服环境" aria-hidden="true">#</a> 11.搭建常用私服环境</h1>
<h2 id="_11-1-搭建yum私服" tabindex="-1"><a class="header-anchor" href="#_11-1-搭建yum私服" aria-hidden="true">#</a> 11.1.搭建yum私服</h2>
<h2 id="_11-1-1-安装httpd" tabindex="-1"><a class="header-anchor" href="#_11-1-1-安装httpd" aria-hidden="true">#</a> 11.1.1.安装httpd</h2>
<pre><code>配置阿里云源
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>rpm -ql httpd
</code></pre></div><pre><code>或
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>curl http://127.0.0.1	
</code></pre></div><pre><code>启动apache
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>/bin/systemctl start httpd.service
</code></pre></div><pre><code>配置服务自启动 
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>chkconfig httpd on
</code></pre></div><pre><code>访问apache
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>http://192.168.0.9
</code></pre></div><pre><code>访问失败解决	
如无法访问成功，可开放端口或关闭防火墙
查询服务器的配置文件
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>find / -name httpd.conf
</code></pre></div><pre><code>卸载httpd
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum -y remove httpd
</code></pre></div><h2 id="_11-1-2-安装yum相关工具" tabindex="-1"><a class="header-anchor" href="#_11-1-2-安装yum相关工具" aria-hidden="true">#</a> 11.1.2.安装yum相关工具</h2>
<pre><code>安装createrepo 和 reposync
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum -y install createrepo reposync
</code></pre></div><pre><code>安装 yum-utils
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum install yum-utils
</code></pre></div><pre><code>下载rpm包
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>reposync --repoid=base &amp;&amp;
reposync --repoid=updates &amp;&amp;
reposync --repoid=extras &amp;&amp;
reposync --repoid=epel
</code></pre></div><pre><code>创建存放包的目录
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>mkdir -p /var/www/html/base/ &amp;&amp;
...
<div class="language-text ext-text"><pre v-pre class="language-text"><code>createrepo --update /var/www/html/base/ &amp;&amp;
createrepo --update /var/www/html/updates/ &amp;&amp;
createrepo --update /var/www/html/extras/ &amp;&amp;
createrepo --update /var/www/html/epel/
</code></pre></div><h2 id="_11-1-3-配置切换使用的源为私服的源" tabindex="-1"><a class="header-anchor" href="#_11-1-3-配置切换使用的源为私服的源" aria-hidden="true">#</a> 11.1.3.配置切换使用的源为私服的源</h2>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>cd /etc/yum.repos.d/ &amp;&amp;
cp CentOS-Base.repo CentOS-Base.bak.2022
</code></pre></div><p>修改阿里源为本地源</p>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>vi CentOS-Base.repo
...
<h2 id="_11-1-4-重新生成测试机yum缓存配置" tabindex="-1"><a class="header-anchor" href="#_11-1-4-重新生成测试机yum缓存配置" aria-hidden="true">#</a> 11.1.4.重新生成测试机yum缓存配置</h2>
<pre><code>在测试机器上，先清理已有缓存，再重新生成 yum 源缓存配置，将软件包信息缓存本机，提高搜索安装效率。
</code></pre>
<div class="language-text ext-text"><pre v-pre class="language-text"><code>yum clean all &amp;&amp;
yum makecache
</code></pre></div><h2 id="_11-1-5-使用yum私服来下载软件" tabindex="-1"><a class="header-anchor" href="#_11-1-5-使用yum私服来下载软件" aria-hidden="true">#</a> 11.1.5.使用yum私服来下载软件</h2>
