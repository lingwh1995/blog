      ...
      children: [
          {
              ...
              children:[
                  ...
                  },
                  {
                      ...
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/centos/centos7/shardings/centos7-chapter-4.Centos搭建docker.md",
                  },
                  {
                      text:"5.Centos搭建Rancher",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/centos/centos7/shardings/centos7-chapter-5.Centos搭建Rancher.md",
                  },
                  {
                      text:"6.Centos搭建Minikube",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/centos/centos7/shardings/centos7-chapter-6.Centos搭建Minikube.md",
                  },
                  {
      ...
      children: [
          {
              ...
              children:[
                  {
                      text: "博客内容介绍",
                      link:"/blogs/environment/ubuntu/ubuntu2012/shardings/ubuntu2012-chapter-0.博客内容介绍.md",
                      icon:"note",
                   },
                  {
                      text:"1.安装Ubuntu操作系统",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/ubuntu/ubuntu2012/shardings/ubuntu2012-chapter-1.安装Ubuntu操作系统.md",
                  },
                  {
                      text:"2.Ubuntu操作系统初始设置",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/ubuntu/ubuntu2012/shardings/ubuntu2012-chapter-2.Ubuntu操作系统初始设置.md",
                  },
                  {
                      text:"3.Ubuntu搭建基础开发环境",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/ubuntu/ubuntu2012/shardings/ubuntu2012-chapter-3.Ubuntu搭建基础开发环境.md",
                  },
                  {
                      text:"4.UbuntuCentos搭建docker",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/ubuntu/ubuntu2012/shardings/ubuntu2012-chapter-4.UbuntuCentos搭建docker.md",
                  },
                  {
                      text:"5.UbuntuCentos搭建Rancher",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/ubuntu/ubuntu2012/shardings/ubuntu2012-chapter-5.UbuntuCentos搭建Rancher.md",
                  },
                  {
                      text:"6.UbuntuCentos搭建Minikube",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/ubuntu/ubuntu2012/shardings/ubuntu2012-chapter-6.UbuntuCentos搭建Minikube.md",
                  },
                  {
                      text:"7.Ubuntukubeadm搭建Kubernetes",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/ubuntu/ubuntu2012/shardings/ubuntu2012-chapter-7.Ubuntukubeadm搭建Kubernetes.md",
                  },
                  {
                      text:"8.Ubuntu二进制包搭建Kubernetes",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/environment/ubuntu/ubuntu2012/shardings/ubuntu2012-chapter-8.Ubuntu二进制包搭建Kubernetes.md",
                  },
              ]
          },
          {
      ...
      children: [
          {
              ...
              children:[
                   ...
                   },
                  {
                      ...
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/backend/springcloud/springcloud-eureka/shardings/springcloud-eureka-chapter-1.安装SpringCloud-Eureka操作系统.md",
                  },
                  {
                      text:"2.SpringCloud-Eureka操作系统初始设置",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/backend/springcloud/springcloud-eureka/shardings/springcloud-eureka-chapter-2.SpringCloud-Eureka操作系统初始设置.md",
                  },
                  {
                      text:"3.SpringCloud-Eureka搭建基础开发环境",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/backend/springcloud/springcloud-eureka/shardings/springcloud-eureka-chapter-3.SpringCloud-Eureka搭建基础开发环境.md",
                  },
                  {
                      text:"4.SpringCloud-EurekaCentos搭建docker",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/backend/springcloud/springcloud-eureka/shardings/springcloud-eureka-chapter-4.SpringCloud-EurekaCentos搭建docker.md",
                  },
                  {
                      text:"5.SpringCloud-EurekaCentos搭建Rancher",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/backend/springcloud/springcloud-eureka/shardings/springcloud-eureka-chapter-5.SpringCloud-EurekaCentos搭建Rancher.md",
                  },
                  {
                      text:"6.SpringCloud-EurekaCentos搭建Minikube",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/backend/springcloud/springcloud-eureka/shardings/springcloud-eureka-chapter-6.SpringCloud-EurekaCentos搭建Minikube.md",
                  },
                  {
                      text:"7.SpringCloud-Eurekakubeadm搭建Kubernetes",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/backend/springcloud/springcloud-eureka/shardings/springcloud-eureka-chapter-7.SpringCloud-Eurekakubeadm搭建Kubernetes.md",
                  },
                  {
                      text:"8.SpringCloud-Eureka二进制包搭建Kubernetes",
                      icon:"article",
                      collapsable: true,
                      link:"/blogs/backend/springcloud/springcloud-eureka/shardings/springcloud-eureka-chapter-8.SpringCloud-Eureka二进制包搭建Kubernetes.md",
                  },
              ]
          },
          {
