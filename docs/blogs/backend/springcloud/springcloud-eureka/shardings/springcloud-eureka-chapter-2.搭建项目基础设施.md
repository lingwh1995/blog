...
## 2.3.创建项目父工程 {#_2-3-anchor}
### 2.3.1.创建父工程 {#_2-3-1-anchor}
	在idea中创建一个名为springcloud-eureka的maven工程,创建完成后打开该工程,删除src文件夹
### 2.3.2.编写父工程pom.xml {#_2-3-2-anchor}
...
## 2.4.创建项目依赖的公共模块 {#_2-4-anchor}
### 2.4.1.模块目录结构 {#_2-4-1-anchor}
```md
@include(../projects/springcloud-eureka/springcloud-api-commons/tree.md)
```
### 2.4.2.创建模块 {#_2-4-2-anchor}
