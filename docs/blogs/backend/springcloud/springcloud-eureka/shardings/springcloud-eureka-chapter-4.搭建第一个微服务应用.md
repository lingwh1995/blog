...
## 4.4.搭建服务提供者第一个节点 {#_4_4_}
### 4.4.1.模块简介 {#_4_4_1_}
    服务提供者第一个节点,启动端口: 8001
### 4.4.2.模块目录结构 {#_4_4_2_}
```md
...
```
### 4.4.10.编写模块controller {#_4_4_10_}
```java
...
## 4.5.搭建服务提供者第二个节点 {#_4_5_}
### 4.5.1.模块简介 {#_4_5_1_}
    服务提供者第二个节点,启动端口: 8002
### 4.5.2.模块目录结构 {#_4_5_2_}
```md
...
```
### 4.5.10.编写模块controller {#_4_5_10_}
```java
...
## 4.7.启动并测试第一个微服务应用 {#_4_7_}
### 4.7.1.启动第一个微服务应用 {#_4_7_1_}
```mermaid
flowchart LR
