...
```
### 5.4.6.编写模块config {#_5-4-6-anchor}
```java
...
```
### 5.4.7.编写模块controller {#_5-4-7-anchor}
```java
...
```
### 5.4.8.编写负载均衡规则配置类 {#_5-4-8-anchor}
```java
...
### 5.5.6.编写模块config {#_5-5-6-anchor}
```java
...
```
### 5.5.7.编写模块controller {#_5-5-7-anchor}
```java
...
```
### 5.6.6.编写模块config {#_5-6-6-anchor}
```java
...
```
### 5.6.7.编写模块controller {#_5-6-7-anchor}
```java
...
```
### 5.6.8.编写自定义的负载均衡算法策略 {#_5-6-8-anchor}
```java
...
## 5.7.声明式配置方式使用Ribbon实现负载均衡(使用自定义的Ribbon负载均衡策略) {#_5-7-anchor}
### 5.7.1.模块简介 {#_5-7-1-anchor}
    基于Ribbon以声明式配置方式实现的服务消费者,使用自定义的Ribbon负载均衡策略,启动端口: 80
### 5.7.2.模块目录结构 {#_5-7-2-anchor}
```md
...
### 5.7.4.编写模块pom.xml {#_5-7-4-anchor}
```xml
...
```
### 5.7.5.编写模块application.yml {#_5-7-5-anchor}
```yml
...
```
### 5.7.6.编写模块config {#_5-7-6-anchor}
```java
...
```
### 5.7.7.编写模块controller {#_5-7-7-anchor}
```java
...
```
### 5.7.8.编写自定义的负载均衡算法策略 {#_5-7-8-anchor}
```java
