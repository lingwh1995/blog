...
## 9.4.硬编码配置方式使用GateWay(非负载均衡模式) {#9_4_}
### 9.4.1.模块简介 {#9_4_1_}
...
## 9.5.声明式配置方式使用GateWay(非负载均衡模式) {#9_5_}
### 9.5.1.模块简介 {#9_5_1_}
...
## 9.6.硬编码配置方式使用GateWay(负载均衡模式) {#9_6_}
### 9.6.1.模块简介 {#9_6_1_}
...
## 9.7.声明式配置方式使用GateWay(负载均衡模式) {#9_7_}
### 9.7.1.模块简介 {#9_7_1_}
