...
## 3.5.集群(高可用)版EUREKA注册中心搭建 {#_3-5-anchor}
### 3.5.1.章节内容简介 {#_3-5-1-anchor}
    本章节会展示如何搭建一个集群(高可用)版的Eureka注册中心,共有三个节点,Eureka注册中心集群的原理是多个Eureka Server之间相互注册,从而组成一个集群。
### 3.5.2.搭建Eureka集群中第一个节点 {#_3-5-2-anchor}
    模块简介
...
### 3.5.3.搭建Eureka集群中第二个节点 {#_3-5-3-anchor}
    模块简介
...
### 3.5.4.搭建Eureka集群中第三个节点 {#_3-5-4-anchor}
    模块简介
