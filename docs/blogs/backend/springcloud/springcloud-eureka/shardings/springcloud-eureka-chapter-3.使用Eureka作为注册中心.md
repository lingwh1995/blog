...
description: 本章节涉及主要内容有：Eureka注册中心简介,搭建单节点版EUREKA注册中心,搭建集群(高可用)版EUREKA注册中心,具体每个小节中包含的内容可使通过下面的章节内容大纲进行查看,所有代码均经过严格测试，可直接复制运行即可。
headerDepth: 4
isOriginal: true
category:
  - springcloud
...
head:
  - - meta
    - name: keywords
      content: 本章节涉及主要内容有：Eureka注册中心简介,搭建单节点版EUREKA注册中心,搭建集群(高可用)版EUREKA注册中心,具体每个小节中包含的内容可使通过下面的章节内容大纲进行查看,所有代码均经过严格测试，可直接复制运行即可。
---
