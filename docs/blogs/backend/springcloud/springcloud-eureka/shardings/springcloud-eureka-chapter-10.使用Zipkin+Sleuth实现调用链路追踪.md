...
```
### 10.4.6.编写模块Mybatis配置文件 {#_10_4_6_}
```xml
...
```
### 10.4.9.编写模块service实现类 {#_10_4_9_}
```java
...
```
### 10.4.10.编写模块controller {#_10_4_10_}
```java
...
```
### 10.5.6.编写模块Mybatis配置文件 {#_10_5_6_}
```xml
...
```
### 10.5.9.编写模块service实现类 {#_10_5_9_}
```java
...
```
### 10.5.10.编写模块controller {#_10_5_10_}
```java
...
```
### 10.6.7.编写模块controller {#_10_6_7_}
```java
...
## 10.8.测试Zipkin+Sleuth实现调用链路追踪 {#_10_8_}
    启动相关服务    
```mermaid
flowchart LR
