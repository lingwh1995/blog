...
description: 本章节涉及主要内容有：微服务架构图,CAP中占据情况,微服务架构落地实现方案,具体每个小节中包含的内容可使通过下面的章节内容大纲进行查看,所有代码均经过严格测试，可直接复制运行即可。
headerDepth: 4
isOriginal: true
category:
  - springcloud
...
head:
  - - meta
    - name: keywords
      content: 本章节涉及主要内容有：微服务架构图,CAP中占据情况,微服务架构落地实现方案,具体每个小节中包含的内容可使通过下面的章节内容大纲进行查看,所有代码均经过严格测试，可直接复制运行即可。
---
