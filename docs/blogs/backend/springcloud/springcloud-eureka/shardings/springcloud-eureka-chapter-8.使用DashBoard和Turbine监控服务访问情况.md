---
title: 基于Eureka搭建Springcloud微服务-8.使用DashBoard和Turbine监控服务访问情况
description: 本章节涉及主要内容有：使用Hystrix DashBoard监控服务单个节点访问情况,使用Turbine监控服务多个节点访问情况,具体每个小节中包含的内容可使通过下面的章节内容大纲进行查看,所有代码均经过严格测试，可直接复制运行即可。
headerDepth: 4
isOriginal: true
category:
  - springcloud
...
head:
  - - meta
    - name: keywords
      content: 本章节涉及主要内容有：使用Hystrix DashBoard监控服务单个节点访问情况,使用Turbine监控服务多个节点访问情况,具体每个小节中包含的内容可使通过下面的章节内容大纲进行查看,所有代码均经过严格测试，可直接复制运行即可。
---
