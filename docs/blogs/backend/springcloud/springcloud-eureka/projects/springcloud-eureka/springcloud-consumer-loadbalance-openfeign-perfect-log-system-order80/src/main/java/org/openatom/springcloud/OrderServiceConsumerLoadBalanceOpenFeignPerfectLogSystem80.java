...
@EnableFeignClients
public class OrderServiceConsumerLoadBalanceOpenFeignPerfectLogSystem80 {
    public static void main(String[] args) {
        SpringApplication.run(OrderServiceConsumerLoadBalanceOpenFeignPerfectLogSystem80.class, args);
    }
}
