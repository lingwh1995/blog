...
@include(@src/public/enhance/guidance/backend/springcloud/springcloud-eureka/springcloud-eureka-guidance.md{18-})

# 1.安装SpringCloud-Eureka操作系统 {#1.}
...
# 2.SpringCloud-Eureka操作系统初始设置 {#2.}
...
./centos-init.sh
```
# 3.SpringCloud-Eureka搭建基础开发环境 {#3.}
...
# 4.SpringCloud-EurekaCentos搭建docker {#4.}
...
# 5.SpringCloud-EurekaCentos搭建Rancher {#5.}
...
# 6.SpringCloud-EurekaCentos搭建Minikube {#6.}
...
# 7.SpringCloud-Eurekakubeadm搭建Kubernetes {#7.}
...
# 8.SpringCloud-Eureka二进制包搭建Kubernetes {#8.}
