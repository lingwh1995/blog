...
/**
 * 钩子方法形式一:没有具体的业务代码写在里面，主要的价值在于让一部分子类覆盖这个方法，如
 * 	TeaTemplate中的hook()方法
 * SpringIOC容器初始化,ConfigurableApplicationContext这个类中的refresh()这个方法就是模板方法
 * refresh()中postProcessBeanFactory()和Onrefresh()是钩子方法
 * @author lingwh
 *
 */
public class Client {
