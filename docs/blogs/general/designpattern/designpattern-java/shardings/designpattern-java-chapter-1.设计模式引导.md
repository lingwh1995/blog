...
description: 本章节涉及主要内容有：设计模式起源,设计模式是什么,设计模式作用,设计模式目的,设计模式分类,具体每个小节中包含的内容可使通过下面的章节内容大纲进行查看,所有代码均经过严格测试，可直接复制运行即可。
headerDepth: 4
isOriginal: true
category:
  - 设计模式
...
head:
  - - meta
    - name: keywords
      content: 本章节涉及主要内容有：设计模式起源,设计模式是什么,设计模式作用,设计模式目的,设计模式分类,具体每个小节中包含的内容可使通过下面的章节内容大纲进行查看,所有代码均经过严格测试，可直接复制运行即可。
---
