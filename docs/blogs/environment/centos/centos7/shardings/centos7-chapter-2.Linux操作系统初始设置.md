...
## 2.5.设置系统环境变量 {#_2-5-anchor}
```
echo "export LC_ALL=en_US.UTF-8"  >>  /etc/profile &&
source /etc/profile
```

## 2.6.安装curl {#_2-6-anchor}
	后面的操作需要curl，所以首先安装curl
```
yum -y install curl
```

## 2.7.配置yml源 {#_2-7-anchor}
...
## 2.8.安装常用基础系统软件 {#_2-8-anchor}
### 2.8.1.手动安装常用基础软件 {#_2-8-1-anchor}
	安装vim
```
yum -y install vim*
```
...
### 2.8.2.使用脚本安装常用软件 {#_2-8-2-anchor}
	脚本介绍
