...
## 6.9.启动minikube(下面两种启动方式任选一种) {#6_9_}

### 6.9.1.使用docker作为虚拟化引擎(需要先安装Docker) {#6_9_1_}
	注意事项
...
### 6.9.2.使用virtualbox作为虚拟化引擎(需要先安装Virtualbox) {#6_9_2_}
