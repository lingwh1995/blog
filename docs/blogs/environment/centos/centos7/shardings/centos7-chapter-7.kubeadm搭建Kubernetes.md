...
## 7.5.所有节点修改hosts {#7_5_}
	vim /etc/hosts
	192.168.0.6 master
	192.168.0.7 slave1
	192.168.0.8 slave2

## 7.6.所有节点关闭SELinux {#7_6_}
	暂时关闭
```
setenforce 0
```
...
## 7.10.所有节点启动kubelet和docker {#7_10_}
```
