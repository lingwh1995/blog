...
```
# 3.搭建基础开发环境 {#3.}
@include(@src/public/enhance/guidance/environment/windows/windows-server2016/chapter/windows-server2016-guidance-chapter3.md)
...
# 4.搭建docker技术栈 {#4.}
@include(@src/public/enhance/guidance/environment/windows/windows-server2016/chapter/windows-server2016-guidance-chapter4.md)
## 4.3.安装docker
### 4.3.1.在线安装docker
...
# 5.搭建Rancher技术栈 {#5.}
@include(@src/public/enhance/guidance/environment/windows/windows-server2016/chapter/windows-server2016-guidance-chapter5.md)
	下载rancher
```
...
# 6.搭建Minikube {#6.}
@include(@src/public/enhance/guidance/environment/windows/windows-server2016/chapter/windows-server2016-guidance-chapter6.md)
## 6.3.minikube介绍
...
@include(@src/public/enhance/guidance/environment/windows/windows-server2016/chapter/windows-server2016-guidance-chapter7.md)
...
@include(@src/public/enhance/guidance/environment/windows/windows-server2016/chapter/windows-server2016-guidance-chapter8.md)
<!--
	参考网站
...
# 10.搭建Mycat技术栈 {#10.}
@include(@src/public/enhance/guidance/environment/windows/windows-server2016/chapter/windows-server2016-guidance-chapter10.md)
...
# 11.搭建常用私服环境 {#11.}
@include(@src/public/enhance/guidance/environment/windows/windows-server2016/chapter/windows-server2016-guidance-chapter11.md)
## 11.3.搭建yum私服
## 11.3.1.安装httpd
	配置阿里云源
